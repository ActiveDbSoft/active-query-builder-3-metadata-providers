...
{
    /// <summary> Metadata Provider for Oracle Database through System.Data.OracleClient (Microsoft). </summary>
    /// <seealso cref="ActiveQueryBuilder.Core.OracleNativeMetadataProvider"> Metadata Provider for Oracle Database through Oracle.DataAccess.Client (Oracle) </seealso>
    [ToolboxItem(true)]
	//[ToolboxBitmap(typeof(OracleMetadataProvider))]
	[ToolboxTabNameAttribute("AQB3: Metadata Providers")]
	public class OracleMetadataProvider : BaseMetadataProvider
	{
		...
		static OracleMetadataProvider()
		{
			Helpers.MetadataProviderList.RegisterMetadataProvider(typeof(OracleMetadataProvider));
		}
		...
		public OracleMetadataProvider(IContainer container) : this()
		{
			container.Add(this);
		}
